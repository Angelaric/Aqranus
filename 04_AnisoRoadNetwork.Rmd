...
# Now we can set a speed of each road segment, based on its gradient. We use a default speed of 5 km/h. An uphill gradient decreases this speed, and a downhill gradient increases this speed, all until a given minimum and maximum speed of respectively 2 km/h and 6 km/h.
