# Finding Medieval Aqranus

*ANALYSIS*

## Purpose

This repository stores the scripts modelling the possible locations of the medieval site of Aqranus via spatial buffers, isochrones, distance from neighboring cities and least cost paths.  The paper was presented at CAA 2025 in Athens and is submitted to CHR 2025. 

The rationale for the spatial analysis is: 
...
## Authors
* Angel Bogdanov Grigorov, [ORCID], [Institution], [email]
